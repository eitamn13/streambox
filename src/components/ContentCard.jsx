    ...
    return (
      ...
      >
        <div className="relative aspect-[2/3] rounded-md overflow-hidden bg-[#1f1f1f] transition-all duration-300 group-hover:scale-105 group-hover:shadow-2xl group-hover:z-20">
          ...
          {/* Platform badge */}
          <div
            className="absolute top-2 right-2 w-5 h-5 rounded flex items-center justify-center text-[7px] font-black z-10"
    ...
    >
      <div className="relative aspect-[2/3] rounded-md overflow-hidden bg-[#1f1f1f] transition-all duration-300 group-hover:scale-105 group-hover:shadow-2xl group-hover:z-20">
        ...
        {showSourceIndicator && hasSources && (
          <div className="absolute bottom-2 right-2 w-2 h-2 rounded-full bg-[#46d369] shadow-[0_0_8px_rgba(70,211,105,0.6)] z-10" />
        )}
        {showSourceIndicator && !hasSources && (
          <div className="absolute bottom-2 right-2 w-2 h-2 rounded-full bg-[#e50914] shadow-[0_0_8px_rgba(229,9,20,0.6)] z-10" />
        )}
